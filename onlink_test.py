...
def process_cram_file(cram_file: str, output_path: str):
    ...
    output_path = os.path.join(output_path, "output.npy")
...
#   $ python ~/ugbio-utils/onlink_test.py /data/Runs/olink/409959-Olink_HT31-Z0008.1M.bam /data/Runs/olink/matrix_output.bin