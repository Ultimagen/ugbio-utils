...
from python_libs.omics.compare_cromwell_omics import (
...
def single_run(omics_run_id, omics_session, output_path):
    ...
    resources_df = pd.DataFrame({
        ...
        f"{omics_run_id}_resources": [task['resources'] for task in tasks_costs],
        f"{omics_run_id}_instance": [task['instance'] for task in tasks_costs]})
