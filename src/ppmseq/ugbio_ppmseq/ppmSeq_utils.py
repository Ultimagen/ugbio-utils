...
def read_tags_from_subsampled_sam(
    ...
    # Expose sr under START / END continuous columns too for any downstream plotter that
    # groups by those. For post-RAMP data both directions share the single per-read sr value.
