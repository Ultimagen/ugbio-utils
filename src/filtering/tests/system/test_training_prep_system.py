...
@patch("ugbio_comparison.vcf_pipeline_utils.VcfPipelineUtils.run_vcfeval_concordance")
@patch("ugbio_filtering.training_prep.calculate_labeled_vcf")
def test_prepare_ground_truth(mock_run_vcfeval_concordance, mock_calculate_labeled_vcf, tmpdir, resources_dir):
