...
def test_merge_trimmer_histograms(tmpdir, inputs_dir):
    trimmer_histograms = [
        str(inputs_dir / "029917001_1_Z0098.histogram.csv"),
        str(inputs_dir / "029917001_2_Z0098.histogram.csv"),
    ]
    expected_output = str(inputs_dir / "EXPECTED.029917001_Z0098.histogram.csv")
